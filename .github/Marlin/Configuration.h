...
#define STRING_CONFIG_H_AUTHOR "(Andrea Dondolini, Tatara)" // Who made the changes.
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 33, 1, 0 }
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  //#define FIL_RUNOUT_PIN 1_26 // Creality CR10-S stock sensor
